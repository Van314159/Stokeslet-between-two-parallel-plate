...
'''
x: the integral parameter.
h: height of force point.
x3: height of field point.
r: the longitute radius from force point to field point.
zeros_j: the zeors of bessel function.
'''
...
'''h0 is the lenght scale.
 k is the recipocal vector. 
 So the integral parameter is dimensionless.
'''
h0 = 1.
pi = mp.pi
k0 = 2. * pi / h0
...
def far_integral(func, radius, z, hight, Height, imax, **kwards):
    '''Return integral in finite range.'''
